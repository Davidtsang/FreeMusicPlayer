...
-(void)alertUserCannotUse
{
    NSString *msg =NSLocalizedString(@"If you want to use this feature, you must allow upload your music information(audio tags and link) when you got a song or audio at website. (If you want to close the upload function, please check the \"Settings\" at the main screen)", @"");
    
    UIAlertView* alertView = [[UIAlertView alloc]
                              initWithTitle:NSLocalizedString(@"Notice", @"")
                              message:msg  delegate:self
                              cancelButtonTitle:NSLocalizedString(@"No", @"")
                              otherButtonTitles:NSLocalizedString(@"Yes, allow", @""),nil];
    [alertView show];
    [alertView release];
}
